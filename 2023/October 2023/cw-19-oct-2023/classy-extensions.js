...
//  introducing extends keyword. You will be preloaded with the Animal 
//  class, so you should only edit the Cat class.
...
// 'Mr Whiskers meows.'
// The name attribute is passed with this.name (JS), @name (Ruby) or 
// self.name (Python).
